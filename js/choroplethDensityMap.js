...
Promise.all([
    ...
    console.log("Raw area data sample (first 10 rows):", landAreaData.slice(0, 10));

    // Filter the emissions dataset for the year 2018
    const emissionsYear = 2018;
    const emissionsFiltered = emissionsData.filter(d => +d.Year === emissionsYear);
    ...
    // Prepare the GeoJSON features for the map
